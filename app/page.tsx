...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-mist">
      ...
      {/* Header mobile */}
      <header className="md:hidden bg-white border-b border-mist-dark px-4 py-3 flex items-center justify-between">
      ...
      <main className="md:ml-60 pb-24 md:pb-8 px-4 py-4 md:px-8 md:py-8 max-w-2xl mx-auto md:mx-0">
